...
public class StuhkAdapter extends ArrayAdapter {
    private final int resourceId;
    private addClickListerner1 listener;
    public StuhkAdapter(Context context, int textViewResourceId, List<stuhk.NoBean> object1) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        final stuhk.NoBean co=(stuhk.NoBean)getItem(position);
    ...
    public void setCusClickListener(addClickListerner1 cusClickListener) {
